<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fornitore.aspx.cs" Inherits="CarrelloGallesio.Fornitore" %>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <asp:Button ID="btnAggiungi" runat="server" OnClick="btnAggiungi_Click" Text="Aggiungi" CssClass="btn-custom" />

                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <asp:Button ID="Button1" runat="server" Text="Modifica" CssClass="btn-custom" OnClick="Button1_Click1" />
